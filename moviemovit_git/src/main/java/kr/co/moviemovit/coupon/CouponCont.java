...
public class CouponCont {
  ...
  public CouponCont() {
    System.out.println("---------- CouponCont() 객체 생성");
  }//default constructor
  
  
/*********************************** 쿠폰 목록 *********************************************/
  // 결과확인 http://localhost:9090/moviemovit/coupon/list.do
  @RequestMapping(value="/coupon/list.do")
  public ModelAndView list(CouponDTO dto) {
