...
<div class="home-section text-center ">
 <div class="table-users">
   ...
   <input type="hidden" name="peoName" value="${dto.peoName }">
   <input type="hidden" name="peoCode" value="${dto.peoCode }">
   <table>
     <tr>
       <td><img class="mimg" src="./storage/${dto.peoPic }" width="150" height="150" ></td>
       <td>${dto.peoName}</td>
     </tr>
   </table>
   <div class="cbp-mc-submit-wrap">
   <input class="cbp-mc-button" type="submit" value="삭제">
   </div>
 </form>
 </div>    
 </div>
