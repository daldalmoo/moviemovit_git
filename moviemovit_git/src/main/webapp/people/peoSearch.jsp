...
<div class="searchform">
  <input class="searchfield" type="text" value="인물 입력" onfocus="if (this.value == '인물 입력') {this.value = '';}" onblur="if (this.value == '') {this.value = '인물 입력';}" />
...
/* $(".selectbutton").click(function(){
  // 해당 줄의 uid 값 가져오기
  var list = $(this).parent().prev().text();
  alert(list);
  
  // 부모창에 uid 입력
  opener.document.getElementById("list").value = list;
  window.close();
}); */
...
$(".searchfield").keyup(function () {
  ...
  $.ajax({
    type: "POST",
    cache: false, //비동기식 false, 동기식 true
    url: "peoresult.do",
    dataType: "html",
